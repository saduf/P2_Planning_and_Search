...
from planning_utils import a_star_graph, heuristic_graph, create_grid_and_edges, point, collinearity_check, prune_path, closest_point
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        grid_graph, edges = create_grid_and_edges(data, TARGET_ALTITUDE, SAFETY_DISTANCE)
